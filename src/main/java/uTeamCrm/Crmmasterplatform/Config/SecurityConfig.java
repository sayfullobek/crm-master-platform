...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/api/help/**","/api/course/**", "/api/attachment/**", "/api/bio/**", "/api/wallet/**","/api/definition/**","/api/room/**", "/api/pupil/**", "/api/payment/**", "/api/teacher/**", "/api/group/**", "/api/statistic/**", "/api/paymentHistory/**")
                .permitAll()
                .antMatchers("/api/**")
                .authenticated();
